...
urlpatterns = [
    ...
    path('project/<slug:project_url_id>/data/delete', views.DeleteProjectData.as_view(), name='project_data_delete'),
    path('project/<slug:project_url_id>/responses', views.ResponsesApiView.as_view(), name='responses'),
    path('project/<slug:project_url_id>/participant/<slug:participant_id>/delete', views.DeleteParticipantAPI.as_view(), name='participant_delete')
]
