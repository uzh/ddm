...
urlpatterns = [
    path(
        r"", RedirectView.as_view(pattern_name="ddm_projects:list"), name="ddm_landing"
    ),
    path(
        r"studies/<slug:slug>/",
    ...
    path(
        r"projects/<slug:project_url_id>/questionnaire/",
        include("ddm.questionnaire.urls", namespace="ddm_questionnaire"),
    ),
    path(
        r"projects/<slug:project_url_id>/data-donation/",
