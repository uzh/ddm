...
class TestSignals(TransactionTestCase):
    ...
    def setUp(cls):
        ...
        cls.file_uploader_a = FileUploader.objects.create(
            project=cls.project,
        ...
        cls.file_uploader_b = FileUploader.objects.create(
            project=cls.project,
        ...
        cls.file_uploader_c = FileUploader.objects.create(
            project=cls.project,
    ...
    def test_post_delete_signal_for_donation_instruction(self):
        ...
        instruction_b = DonationInstruction.objects.create(
            file_uploader=self.file_uploader_a, index=2
        )
        instruction_c_pk = DonationInstruction.objects.create(
            file_uploader=self.file_uploader_a, index=3
        ).pk
