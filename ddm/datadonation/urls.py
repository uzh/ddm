...
from ddm.datadonation.transfer import views as transfer_views

instruction_patterns = (
    [
        path(r"", views.InstructionOverview.as_view(), name="overview"),
        path(r"create/", views.InstructionCreate.as_view(), name="create"),
        path(r"<int:pk>/edit/", views.InstructionEdit.as_view(), name="edit"),
        path(r"<int:pk>/delete/", views.InstructionDelete.as_view(), name="delete"),
    ],
    "instructions",
)
...
blueprint_patterns = (
    [
        ...
        path(r"import/", transfer_views.BlueprintImportView.as_view(), name="import"),
        path(r"<int:pk>/edit/", views.BlueprintEdit.as_view(), name="edit"),
        path(r"<int:pk>/delete/", views.BlueprintDelete.as_view(), name="delete"),
        path(
            r"<int:pk>/copy/", transfer_views.BlueprintCopyView.as_view(), name="copy"
        ),
        path(
            r"<int:pk>/export/",
            transfer_views.BlueprintExportView.as_view(),
            name="export",
        ),
    ],
    "blueprints",
...
urlpatterns = [
    ...
    path(r"file-uploader/", include(uploader_patterns)),
    path(
