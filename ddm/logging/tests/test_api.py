...
from ddm.logging.models import (
    ExceptionLogEntry, ExceptionRaisers, EventLogEntry
)
...
class TestExceptionAPI(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.post_url = reverse(
            'ddm_logging:exceptions_api',
            args=[cls.project.url_id]
        )
        cls.post_data = {
...
class TestEventLogAPIView(TestCase):
    ...
    def test_filter_by_description(self):
        ...
        self.assertEqual(
            response.data['rows'][0]['description'],
            'Token regenerated'
        )
...
class TestExceptionLogAPIView(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.api_url = reverse(
            'ddm_logging:exception_logs_api',
            args=[cls.project.url_id]
        )
    ...
    def test_filter_by_exception_type(self):
        ...
        self.assertEqual(response.data['total'], 1)
        self.assertEqual(
            response.data['rows'][0]['exception_type'],
            'ValidationError'
        )
    ...
    def test_filter_by_participant(self):
        ...
        response = client.get(
            self.api_url,
            {'participant': self.participant.external_id[:8]}
        )
    ...
    def test_ordering_by_participant(self):
        ...
        response = client.get(
            self.api_url,
            {'ordering': 'participant__external_id'}
        )
        self.assertEqual(response.status_code, 200)
