...
urlpatterns = [
    ...
    path(
        r"questionnaire/progress/",
        views.QuestionnaireProgressView.as_view(),
        name="questionnaire_progress",
    ),
    ...
    path(r"theme.css", views.ProjectThemeView.as_view(), name="theme_css"),
]
