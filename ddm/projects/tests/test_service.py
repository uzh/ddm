...
class TestDonationProject(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.open_question = OpenQuestion.objects.create(
            project=cls.project, name="some name", variable_name="open_question_1"
        )
    ...
    def test_get_participant_variables_participant(self):
        ...
        expected = {
            ...
            "_start_time": self.participant.start_time.replace(
                microsecond=0
            ).isoformat(),
            "_end_time": None,
            "_completed": self.participant.completed,
            "_briefing_consent": self.participant.extra_data.get(
                "briefing_consent", None
            ),
        }
        self.assertDictEqual(result, expected)
    ...
    def test_get_questionnaire_variables_participant(self):
        ...
        expected = {
            "_quest_time_submitted": self.response.time_submitted.replace(
                microsecond=0
            ).isoformat(),
