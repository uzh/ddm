...
class TestMatrixQuestion(TestQuestionModelsBaseCase):
    ...
    def setUpTestData(cls):
        ...
        cls.scale_a = ScalePoint.objects.create(question=cls.question, index=1, value=1)
        cls.scale_b = ScalePoint.objects.create(question=cls.question, index=2, value=6)
...
class FilterConditionModelTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.item = QuestionItem.objects.create(
            question=cls.question_alt, index=1, value=1
        )
