...
class TestParticipationFlowUrls(SimpleTestCase):
    ...
    def test_project_briefing_url_resolves(self):
        ...
        self.assertEqual(resolve(url).func.view_class, participation_flow.BriefingView)
    ...
    def test_project_debriefing_url_resolves(self):
        ...
        self.assertEqual(resolve(url).func.view_class, participation_flow.DebriefingView)
