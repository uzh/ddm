...
DDM uses [django-ckeditor-5](https://pypi.org/project/django-ckeditor-5/) as richt text editor used in some
form fields.
...
the section on [including data dynamically in a question](../../researchers/topics/templating_features.md))
