...
Currently, the APIs only support GET requests.
...
== Available Endpoints
Currently, three API-endpoints are available for researchers: the Project Overview API, the Donations API, and the Responses API.
...
[source]
----
GET /api/project/4/overview HTTPS
...
[source]
----
GET /api/project/4/responses?participants=cSCslglsu2Mv0j0ryz8lGrcA&include_snapshot=true HTTPS
Authorization: Token 1176fcf7d0203db1e097861ef7442b328f1bb7f1
Host: <hostname>
----
